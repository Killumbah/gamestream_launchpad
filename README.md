**All credits go to [cgarst](https://github.com/cgarst) for creating this software. This fork simply removes the resolution changer and adds functionality for Steam Big Picture Mode.**
